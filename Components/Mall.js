      ...
      const { navigate } = this.props.navigation;
        ...
        <ScrollView>
           <View style={styles.containerTop}>
                 <ImageBackground source={require('../assets/mall.jpg')}
        style={styles.imagetop}>
                      <Text style={styles.texts}>Guildford Town Center</Text>
            <Text style={styles.texts2}>10355 152 St, Surrey, BC</Text>
        </ImageBackground>
            </View>
          <View> 
            ...
            <View style={{paddingTop: 30}}>
              ...
              <Text style={styles.texts5}> Even though the whole experice of the mall was great, I have to give this mall a three star review because the entrances are not very wheelchair accessible. </Text>
            </View>
